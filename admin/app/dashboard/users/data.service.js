...
var DataService = (function () {
    ...
    DataService.prototype.getUsers = function () {
        return this.http.get("/admin/api/auth_service.php").map(function (res) { return res.json(); });
    };
    DataService.prototype.getRoles = function () {
        return this.http.get("/admin/api/auth_service.php?target=roles").map(function (res) { return res.json(); });
    };
